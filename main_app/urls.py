...
urlpatterns = [
    ...
    path('patients/<int:patient_id>/add_procedure/',
         views.add_procedure, name='add_procedure'),
    ...
    path('providers/create/', views.ProviderCreate.as_view(),
         name='providers_create'),
    path('providers/<int:pk>/update/',
         views.ProviderUpdate.as_view(), name='providers_update'),
    path('providers/<int:pk>/delete/',
         views.ProviderDelete.as_view(), name='providers_delete'),
    path('patients/<int:patient_id>/assoc_provider/<int:provider_id>/',
         views.assoc_provider, name='assoc_provider'),
